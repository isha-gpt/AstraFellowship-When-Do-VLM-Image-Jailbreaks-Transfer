...
MODELS_TO_NICE_STRINGS_DICT = {
    ...
    "one-stage+7b": "One-Stage Training (1S)",
    "reproduction-llava-v15+7b": "Two-Stage Training",
    "train-1.25-epochs+7b": "1S, 1.25 Epochs",
    "train-1.5-epochs+7b": "1S, 1.5 Epochs",
    "train-2-epochs+7b": "1S, 2 Epochs",
    "train-3-epochs+7b": "1S, 3 Epochs",
    "llava-lvis4v+7b": "1S + LVIS-Instruct-4V",
    "llava-lrv+7b": "1S + LRV-Instruct",
    "llava-lvis4v-lrv+7b": "1S + LVIS + LRV",
}
...
default_attack_config = {
    ...
    "image_kwargs": {
        ...
        "patch_size": 10,  # Default to full image size (no masking)
    },
    "lightning_kwargs": {
...
default_eval_config = {
    ...
    "model_to_eval": "{'prism-siglip+7b', 'reproduction-llava-v15+7b'}",
    "model_generation_kwargs": {},
    "n_generations": 100,
    "seed": 0,
    "wandb_attack_run_id": "buhcj0l8",  # Your run ID
}
